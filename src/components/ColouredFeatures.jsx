    ...
    return(
        <div className={`flex flex-col items-center text-center pb-[50px] px-[50px] sm:px-0 gap-4 sm:gap-0 ${styles}`}>
            ...
            <div className="flex flex-col gap-2 mt-[30px]">
                ...
                <Button title={"Get Started"} styles="bg-purple-700 hover:border-none hover:bg-purple-900 w-[150px] mt-[20px]" linkStyles="text-[12px] font-sm" />
                </div>
                ...
                <h1 className="font-bold text-[30px]">Cold Storage</h1>
                    ...
                    <Button title={"Be Secured"} styles="bg-gray-600 hover:border-none hover:bg-gray-800 w-[150px] mt-[10px]" linkStyles="text-[12px] font-sm" />
