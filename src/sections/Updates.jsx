...
const Updates = () => {
  return (
    <div className="md:flex md:flex-row justify-center text-left mx-[50px] md:gap-[100px] gap-8 mt-[100px] flex flex-col items-center md:items-start">
        <div className="flex flex-col md:items-start items-center text-center md:text-left">
        <h1 className="w-[550px] sm:text-[50px] font-bold text-[35px] leading-[50px] sm:leading-normal">News and Market Updates</h1>
        ...
        <div className="flex flex-col md:gap-3 gap-6">
            {News.map((item, index) => (
                <div className="flex flex-col bg-gray-200 rounded-md p-[15px] md:w-[400px] w-full cursor-pointer md:h-[130px] justify-between h-[150px] hover:text-white hover:bg-red-700 transition duration-500" key={index}>
                    <Link to={"/blogs"}>
