...
const Hero = () => {
   return (
    <div className="flex flex-col md:flex-row pt-[150px] pb-[30px] px-[50px] bg-[#010221] md:text-justify md:justify-normal text-center justify-center items-center h-screen w-full">
      ...
      <div className="flex flex-col justify-center items-center md:justify-normal md:items-start z-30">
        ...
        <img className="md:w-[300px] w-[300px] h-[400px] rounded-md" src="lol" alt="Hero" />
        </div>
    </div>
  )
}
