  ...
  return (
    <div className="md:flex md:flex-col items-center justify-center mt-[50px] py-[30px] flex-col-reverse flex text-center px-[50px]">
      ...
      <div>
        ...
        <p className="md:text-[16px] text-center pt-[10px] text-gray-500 text-[13px]">Explore our educational resources designed to help you become a more informed investor. Learn how to get started with crypto, <br /> manage your profile, and make strategic decisions.</p>
